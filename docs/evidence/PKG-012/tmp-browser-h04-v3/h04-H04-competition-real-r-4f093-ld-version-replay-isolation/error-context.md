...
- Location: tests\browser\h04.spec.ts:228:1

# Error details

```
Error: No KeyR input reached the flight: {"phase":"FallSettled","tick":1528,"distance":59.585150320044896,"status":"fall","heightAboveSurface":0,"events":["0 gateOpen","867 takeoffImpulseStart","889 takeoffEdge","1167 measured","1167 contact","1167 fall","1527 fallSettled"]}
