...
- [x] Wszystkie fazy skoku i błędy mają spójne, czytelne animacje; brak placeholderów na normalnej ścieżce (bank P42 + poza hamowania, PKG-016). VISUAL USER PASS 25.09.2026.
