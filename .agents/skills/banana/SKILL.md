...
# Banana Codex -- Creative Director for AI Image Generation
...
## Core Principle: Codex as Creative Director
...
For `/banana edit`, Codex should also enhance the edit instruction:
...
to search 2,500+ curated prompts. Otherwise, Codex should generate prompt
