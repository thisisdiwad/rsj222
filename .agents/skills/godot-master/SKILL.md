...
Every section earns its tokens by focusing on **Knowledge Delta** — the gap between what Codex already knows and what a senior Godot engineer knows from shipping real products.
