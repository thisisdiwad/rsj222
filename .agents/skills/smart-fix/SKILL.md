...
Do this step directly in Codex CLI (legacy playbook referenced subagent: error-debugging::error-detective).
...
```
Analyze error traces, logs, and observability data for: (use the user's prompt)
...
Do this step directly in Codex CLI (legacy playbook referenced subagent: error-debugging::debugger).
...
- AI-assisted code explanation (Codex/Copilot to understand complex logic)
...
- AI pair programming (GitHub Copilot, Codex) for test generation
...
- AI-generated test cases (GitHub Copilot, Codex)
...
Do this step directly in Codex CLI (legacy playbook referenced subagent: comprehensive-review::code-reviewer).
...
- AI-assisted code review rules (GitHub Copilot, Codex)
...
- Codex (comprehensive code analysis, architecture review)
...
Issue to resolve: (use the user's prompt)
```
## Output Format
