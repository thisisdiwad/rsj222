...
```bash
# Load a single skill
bb ~/.Codex/skills/skill-loader/load.bb skill-name

# Load multiple skills with GF(3) trit assignment
bb ~/.Codex/skills/skill-loader/load.bb skill1:-1 skill2:0 skill3:+1

# List loadable skills
bb ~/.Codex/skills/skill-loader/load.bb --list

# Query skill lattice
bb ~/.Codex/skills/skill-loader/load.bb --lattice

# Reverse derivative: find skills that influence current state
bb ~/.Codex/skills/skill-loader/load.bb --reverse
```
...
(def skills-dir (str (System/getProperty "user.home") "/.Codex/skills"))
