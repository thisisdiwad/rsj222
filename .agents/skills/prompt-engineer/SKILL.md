...
#### Anthropic Codex (Codex Opus 4.5, Sonnet 4.5, Haiku 4.5)

- Constitutional AI alignment with Codex's training
- Tool use optimization for complex workflows
- Computer use prompting for automation tasks
- XML tag structuring for clear prompt organization
- Context window optimization for long documents (200K tokens)
- Prompt caching for cost optimization
- Safety considerations specific to Codex's capabilities
